...
const hero_data: DataType = {
  title_1: `Make it prove`,
  title_2: `With Aptioon`,
  des: `Mint your username. Prove your socials. Display it anywhere.`,
  links: [{ title: "Telegram" }, { title: "Twitter" }, { title: "Github" }],
};
